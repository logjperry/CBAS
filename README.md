...
<div style="display: flex; flex-direction:column; align-items: center; justify-content: space-around; padding: 10px">
    ...
    <div style="text-align: center; width: 400px; padding: 10px">
...
<div style="display: flex; flex-direction:column; align-items: center; justify-content: flex-end; padding: 10px;">
    ...
    <div style="text-align: center; width: 400px; padding: 10px">
        An example of the CBAS model validation module. The module provides a simple interface for visualizing the performance of a deepethogram or CBAS sequence model on naive test sets. The user can use the module to visualize the model's performance on the videos, to calculate the model's performance metrics (precision, recall, f1-score, balanced accuracy, etc.), and to see the balance of the test set.
    </div>
</div>
...
<div style="display: flex; flex-direction:column; align-items: center; justify-content: flex-end; padding: 10px;">
    <img src="./cbas_headless/assets/comparison.png" alt="Average Transition Raster Comparison Across Populations" style="width: 500px; height: auto;">
    <div style="text-align: center; width: 400px;">
