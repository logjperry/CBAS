...
def train_autoencoder(data_loader, seq_len=16):
    ...
    m_path = f'C:\\Users\\Jones-Lab\\Documents\\cbas_test\\fibonacci_dual_encoderT_32_{seq_len}.pth'
...
def load_data(recording_path):
    ...
    train_autoencoder(data_loader, seq_len=1024)
...
def infer(config_path, recording_path):
    ...
    for path in deg_feature_paths:
        ...
        csv_path = os.path.splitext(path)[0]+'_'+str(model_config['seq_length'])+'_fibonacci_dual_32_'+'encodedT'+'.csv'
